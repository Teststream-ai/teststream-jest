...
var TestStreamAPI = /** @class */ (function () {
    ...
    TestStreamAPI.prototype.createProject = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.post(this.serverUrl + '/api/projects', data)];
                    case 1:
                        response = _a.sent();
    ...
    TestStreamAPI.prototype.getProjectBySlug = function (slugId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get(this.serverUrl + '/api/testops/projects/' + slugId, {
                                headers: {
    ...
    TestStreamAPI.prototype.createRun = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post(this.serverUrl + '/api/runs', data, {
                                headers: {
                                    'x-teststream-api-key': this.apiKey,
                                },
                            })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post(this.serverUrl + '/api/run-spec', data, {
                                headers: {
                                    'x-teststream-api-key': this.apiKey,
                                },
                            })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get(this.serverUrl + '/api/run-spec', {
                                params: {
                                    runId: runId,
                                    spec: spec,
                                },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post(this.serverUrl + '/api/results', data, {
                                headers: {
                                    'x-teststream-api-key': this.apiKey,
                                },
                            })];
